...
Tlong Tlong::operator +(Tlong &b){
    ...
    {
        if(sign=='+')
            c=minusing_abs(*this,b);
        else
            c=minusing_abs(b,*this);
    }
    return c;
}
...
int main()
{
    ...
    cin.tie(0);
    cout.tie(0);
    Tlong a,b,res4,res; int n; bool check=true;
    a.readlong(); b.readlong(); cin>>n;
    Tlong ost;
    if(b.is_zero()==0){
        res4=a/b;
        ost=a%b;
    ...
    res=a+b; a.writelong(); cout<<'+'; writelong_b(b); cout<<'='; res.writelong(); cout<<'\n';
    res=a-b; a.writelong(); cout<<'-'; writelong_b(b); cout<<'='; res.writelong(); cout<<'\n';
    res=a*b; a.writelong(); cout<<'*'; writelong_b(b); cout<<'='; res.writelong(); cout<<'\n';

    if(check){
        a.writelong(); cout<<'/'; writelong_b(b); cout<<'='; res4.writelong(); cout<<" ("; ost.writelong(); cout<<')';
    }
    else cout<<"Division by zero.";
    cout<<'\n';

    cout<<n; cout<<"!="; fact_n.writelong(); cout<<'\n';
